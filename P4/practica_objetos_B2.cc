...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACIONX, ROTACIONY, ROTACIONZ, CILINDROY, CILINDROX, CILINDROZ, CONOY, CONOX, CONOZ, ESFERAY, ESFERAX, ESFERAZ} _tipo_objeto;
...
switch (toupper(Tecla1)){
	...
	case '4':modo=SOLID_CHESS;break;
        ...
        case 'N':t_objeto=CONOX;break;
        case 'M':t_objeto=CONOY;break;
        case 'B':t_objeto=CONOZ;break;
        case 'E':t_objeto=ESFERAX;break;
        case 'W':t_objeto=ESFERAY;break;
        case 'A':t_objeto=ESFERAZ;break;
...
// perfil 
ply_perfil.parametros(argv[1]);
vector<_vertex3f> perfil2;
_vertex3f aux;

aux.x=1.0; aux.y=-1.0; aux.z=0.0;
perfil2.push_back(aux);
aux.x=1.4; aux.y=0; aux.z=0.0;
perfil2.push_back(aux);
aux.x=1.0; aux.y=1.2; aux.z=0.0;
perfil2.push_back(aux);
rotacionx.parametros(ply_perfil.vertices,12,0);
rotaciony.parametros(ply_perfil.vertices,12,1);
rotacionz.parametros(ply_perfil.vertices,12,2);
...
//tri.parametros(ply_perfil.vertices, 12);
