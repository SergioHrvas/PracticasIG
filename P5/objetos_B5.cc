...
glPushMatrix();
if (activo[0]==1) chasis.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor,mate);
else chasis.draw(modo, r1, g1, b1, r2, g2, b2, grosor,mate);

glRotatef(giro_torreta,0,1,0);
glPushMatrix();
glTranslatef(0.0,(chasis.altura+torreta.altura)/2.0,0.0);
if (activo[1]==1) torreta.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor,mate);
else torreta.draw(modo, r1, g1, b1, r2, g2, b2, grosor,mate);
glPopMatrix();

glPushMatrix();
glTranslatef(torreta.anchura/2.0,(chasis.altura+torreta.altura)/2.0,0.0);
glRotatef(giro_tubo,0,0,1);
if (activo[2]==1) tubo.draw(modo, r_p, g_p, b_p, r_p, g_p, b_p, grosor,mate);
else tubo.draw(modo, r1, g1, b1, r2, g2, b2, grosor,mate);
glPopMatrix();
glPopMatrix();
...
c=color_selec[0][0];
glPushMatrix();
chasis.draw(SELECT, c, c, c, c, c, c, 1,ORO);

c=color_selec[0][1];
glRotatef(giro_torreta,0,1,0);
glPushMatrix();
glTranslatef(0.0,(chasis.altura+torreta.altura)/2.0,0.0);
torreta.draw(SELECT, c, c, c, c, c, c, 1,ORO);
glPopMatrix();
...
glTranslatef(torreta.anchura/2.0,(chasis.altura+torreta.altura)/2.0,0.0);
glRotatef(giro_tubo,0,0,1);
tubo.draw(SELECT, c, c, c, c, c, c, 1,ORO);
glPopMatrix();
glPopMatrix();
